package br.com.projetogrenwin.projetogrenwin.controller;
...
import br.com.projetogrenwin.projetogrenwin.model.ProcedimentoRealizado;
import br.com.projetogrenwin.projetogrenwin.repository.ConsultaRepository;
import br.com.projetogrenwin.projetogrenwin.repository.MedicoRepository;
import br.com.projetogrenwin.projetogrenwin.repository.PacienteRepository;
import br.com.projetogrenwin.projetogrenwin.repository.ProcedimentoRepository;
...
public class ConsultaController {
    ...
    public ModelAndView insertproc(Consulta consulta, Consulta novoprocrealizado, BindingResult result, RedirectAttributes redirect) {
        List<Medico> listaMedico = this.medicoRepository.findAll();
        List<Paciente> listaPaciente = this.pacienteRepository.findAll();
        List<Procedimento> listaProcedimento = this.procedimentoRepository.findAll();
